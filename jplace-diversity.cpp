    ...
    */
    ...
    for(auto const& it : postorder( place_tree )) {
        ...
        per_edge_distal_count[ edge_index ] =
            per_edge_distal_count[ lhs_edge_index ] + num_queries( pqrs_per_edge[ lhs_edge_index ] ) +
            per_edge_distal_count[ rhs_edge_index ] + num_queries( pqrs_per_edge[ rhs_edge_index ] );
